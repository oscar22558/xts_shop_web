...
VALUES (NOW()::timestamp, NOW()::timestamp, 85.0, 1);
...
INSERT INTO price_histories (created_at, updated_at, value, item_id)
VALUES (NOW()::timestamp, NOW()::timestamp, 85.0, 2);
...
INSERT INTO price_histories (created_at, updated_at, value, item_id)
VALUES (NOW()::timestamp, NOW()::timestamp, 85.0, 3);
...
INSERT INTO price_histories (created_at, updated_at, value, item_id)
VALUES (NOW()::timestamp, NOW()::timestamp, 85.0, 4);
...
INSERT INTO price_histories (created_at, updated_at, value, item_id)
VALUES (NOW()::timestamp, NOW()::timestamp, 85.0, 5);
...
INSERT INTO price_histories (created_at, updated_at, value, item_id)
VALUES (NOW()::timestamp, NOW()::timestamp, 85.0, 6);
...
INSERT INTO price_histories (created_at, updated_at, value, item_id)
VALUES (NOW()::timestamp, NOW()::timestamp, 85.0, 7);
...
INSERT INTO price_histories (created_at, updated_at, value, item_id)
VALUES (NOW()::timestamp, NOW()::timestamp, 85.0, 8);
